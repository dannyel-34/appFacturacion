...
class ProductosControllerTest < ActionController::TestCase
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post :create, producto: { arch: @producto.arch, cantidad: @producto.cantidad, category_id: @producto.category_id, nombre: @producto.nombre, precio_uni: @producto.precio_uni, stock: @producto.stock }
    end
  ...
  test "should update producto" do
    patch :update, id: @producto, producto: { arch: @producto.arch, cantidad: @producto.cantidad, category_id: @producto.category_id, nombre: @producto.nombre, precio_uni: @producto.precio_uni, stock: @producto.stock }
    assert_redirected_to producto_path(assigns(:producto))
  end
