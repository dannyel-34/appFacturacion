...
class FacturasControllerTest < ActionController::TestCase
  ...
  test "should create factura" do
    assert_difference('Factura.count') do
      post :create, factura: { cliente_id: @factura.cliente_id, fecha: @factura.fecha, modo_pago_id: @factura.modo_pago_id, num_pago: @factura.num_pago }
    end
  ...
  test "should update factura" do
    patch :update, id: @factura, factura: { cliente_id: @factura.cliente_id, fecha: @factura.fecha, modo_pago_id: @factura.modo_pago_id, num_pago: @factura.num_pago }
    assert_redirected_to factura_path(assigns(:factura))
  end
